...
import { Rating } from "../pages/Home/components/Ratting"


export const ProductCard = ({product}) => {
    const {name,overview,price,image_local,best_seller}=product;
  return (
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-800">
